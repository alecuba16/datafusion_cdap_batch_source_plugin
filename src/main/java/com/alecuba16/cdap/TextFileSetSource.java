 ...
 * Methods
 * prepareRun(): Used to configure the input for each run of the pipeline. If the fieldName for a dataset is a macro, their creation will happen during this stage. This is called by the client that will submit the job for the pipeline run.
